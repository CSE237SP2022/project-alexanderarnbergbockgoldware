...
public class Stockle {
	...
	private static Company answer;
		//not sure if this should be static or not, did this to make it work with comparison function
...
//		Company answer = answerGenerator(); //?? how do I get this to work without making a bunch of things static??

		System.out.println("How to Play: " + "Guess any company in the S&P 500 by their stock ticker (Apple = AAPL)");
